...
public class Problem5 {
	...
	public static int isMultipleOf4AndDivisibleBy6(int weight)
	{
	...
	public static void weightInDescendingOrder(int[] weightArr,int[] sumOfWeightArr)
	{
		//Bubble sort 
	...
	public static void print(int[] weightArr,int[] sumOfWeightArr)
	{
